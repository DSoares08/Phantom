...
func DefaultRPCDecodeFunc(rpc RPC) (*DecodedMessage, error) {
	...
	case MessageTypeBlock:
		...
		return &DecodedMessage{From: rpc.From, Data: block}, nil

	case MessageTypeGetStatus:
		return &DecodedMessage{From: rpc.From, Data: &GetStatusMessage{}}, nil
	...
	case MessageTypeStatus:
		...
		return &DecodedMessage{From: rpc.From, Data: statusMessage}, nil
	...
	case MessageTypeGetBlocks:
		...
		return &DecodedMessage{From: rpc.From, Data: getBlocks}, nil
	...
	case MessageTypeBlocks:
		...
		return &DecodedMessage{From: rpc.From, Data: blocks}, nil
